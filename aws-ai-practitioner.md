...
- **Reinforcement learning**: Reinforcement learning is this idea of providing an AI algorithm a “policy” of how to adhere to a certain goal. The most popular example of reinforcement learning is in self-driving cars. With self-driving cars, a policy is formed to adhere to basically making the car drive safely.
